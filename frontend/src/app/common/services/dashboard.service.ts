  ...
  private initCards(): void {
    this.cards = [
      ...
      },
      {
        ...
        buttonIcon: 'upload',
        buttonText: 'Validate Listings',
        description: 'Validate registration numbers when listings are created or updated',
      ...
      },
      {
        ...
        accessPermission: validate_reg_no,
        buttonIcon: 'history',
        buttonText: 'View Validation Reports',
        description: 'Check which listings have a valid registration',
      ...
      },
      {
        ...
        buttonIcon: 'upload',
        buttonText: 'Submit Platform Data',
        description: 'Submit monthly platform listing and takedown reports (For minor platforms: This action will also validate all your listings.) ',
      ...
      },
      {
        ...
        description: 'View reporting history and correct any errors',
        buttonIcon: 'history',
        buttonText: 'View Reporting History',
