...
public partial class DssUserIdentity
{
    ...
    public virtual ICollection<DssEmailMessage> DssEmailMessageAffectedByUserIdentities { get; } = new List<DssEmailMessage>();

    public virtual ICollection<DssEmailMessage> DssEmailMessageInitiatingUserIdentities { get; } = new List<DssEmailMessage>();
