...
ADD COLUMN is_takedown_action_suspended BOOLEAN DEFAULT FALSE;

COMMENT ON COLUMN dss_rental_listing.is_takedown_action_suspended IS 
'Indicates whether takedown notices, requests, and compliance orders are temporarily suspended for this specific listing';
