...
RecurringJob.AddOrUpdate<HangfireJobs>("Clean up addresses", job => job.CleanUpAddresses(), "0 0 31 2 *"); //there's no Feb 31 => not automatically triggered, only from Hangfire dashboard.
