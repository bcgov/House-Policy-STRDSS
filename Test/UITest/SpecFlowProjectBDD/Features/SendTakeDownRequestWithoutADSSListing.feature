...
Examples:
	...
	| STRDSSLg1Test  | 0                   | ListingID - Boundary             | pass           | http://listingURL.com                                        | richard.anderson@dxc.com |                                                                                |
	| STRDSSLg1Test  | 9223372036854775807 | ListingID - Test for Max value   | pass           | http://listingURL.com                                        | richard.anderson@dxc.com |                                                                                |
	| STRDSSLg1Test  | 0                   | ListingURL - Valid URL           | pass           | HTTP://listingURL.com                                        | richard.anderson@dxc.com |                                                                                |
	| STRDSSLg1Test  | 0                   | ListingURL - Valid URL SSL       | pass           | HTTPS://listingURL.com                                       | richard.anderson@dxc.com |                                                                                |
	| STRDSSLg1Test  | 0                   | ListingURL - Long URL            | pass           | http://ReallylongURLstring123123123123123123123123123123.com | richard.anderson@dxc.com |                                                                                |
	| STRDSSLg1Test  | -1                  | ListingID - Negative number test | pass           | http://listingURL.com                                        | richard.anderson@dxc.com | Should pass because non-numberic values are ignored and Listing ID is optional |
	| STRDSSLg1Test  | test                | ListingID - Test for string      | pass           | http://listingURL.com                                        | richard.anderson@dxc.com | should pass because non-numberic values are ignored and Listing ID is optional |
	| STRDSSLg1Test  | e                   | ListingID - Test for exponential | pass           | http://listingURL.com                                        | richard.anderson@dxc.com | should pass because non-numberic values are ignored and Listing ID is optional |
	| STRDSSLg1Test  | 0                   | ListingURL - Invalid URL         | fail           | http://listingURL                                            | richard.anderson@dxc.com |                                                                                |
