#Physical Data Diagram (Sprint 16)
...
### Physical Data Diagram (Sprint 16)
![img](./PhysicalDataDiagram(Sprint16).svg)
...
|  | local\_government\_type| varchar(50)  | A sub-type of local government organization used for sorting and grouping of members |
...
| &#11016; | platform\_type| varchar(25)  | Foreign key |
| * | upd\_dtm| timestamptz  | Trigger-updated timestamp of last change |
|  | upd\_user\_guid| uuid  | The globally unique identifier (assigned by the identity provider) for the most recent user to record a change |
