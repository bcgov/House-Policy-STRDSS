/* Create all Sprint 19 DB Objects STR DSS */
...
CREATE  TABLE dss_organization ( 
	...
	is_str_prohibited    boolean    ,
	is_straa_exempt      boolean    ,
	is_principal_residence_required boolean    ,
	is_business_licence_required boolean    ,
	business_licence_format_txt varchar(50)    ,
...
CREATE  TABLE dss_physical_address ( 
	...
	site_no              varchar(50)    ,
	block_no             varchar(50)    ,
	reg_rental_unit_no varchar(50),
	reg_rental_street_no varchar(50),
	reg_rental_postal_code varchar(7),
...
CREATE  TABLE dss_user_identity ( 
	...
	external_identity_cd varchar(100)    ,
...
CREATE OR REPLACE VIEW dss_local_gov_vw AS SELECT do2.organization_id,
   ...
   FROM (dss_organization do2
     LEFT JOIN dss_local_government_type lgt ON (((lgt.local_government_type)::text = (do2.local_government_type)::text)))
  WHERE ((do2.organization_type)::text = 'LG'::text);

CREATE OR REPLACE VIEW dss_platform_vw AS SELECT do2.organization_id,
    do2.organization_type,
    do2.organization_cd,
    do2.organization_nm,
   ...
   FROM ((((((dss_organization do2
     LEFT JOIN dss_platform_type dpt ON (((dpt.platform_type)::text = (do2.platform_type)::text)))
