...
namespace UITest.Models
{
    public class EditSubPlatformPageModel
    {
        ...
        public static string SaveButton { get => "body > app-root > app-layout > div.content > app-edit-sub-platform > div.actions.ng-star-inserted > button:nth-child(1)"; }
        public static string CancelButton { get => "body > app-root > app-layout > div.content > app-edit-sub-platform > div.actions.ng-star-inserted > button.p-element.p-button-transparent.p-button.p-component"; }
