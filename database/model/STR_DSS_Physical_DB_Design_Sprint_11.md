#Physical Database Design (Sprint 11)
Generated using [DbSchema](https://dbschema.com)




### Physical Data Diagram (Sprint 11)
![img](./PhysicalDataDiagram(Sprint11).svg)
...
|  | business\_licence\_no| varchar(230)  | The local government issued licence number that applies to the rental offering |
...
|  | full\_nm| varchar(230)  | The full name of the contact person as inluded in the listing |
