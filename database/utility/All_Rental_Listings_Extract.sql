...
LEFT JOIN dss_rental_listing_action drla on drla.rental_listing_action_id = (
	select a.rental_listing_action_id
...
LEFT JOIN dss_email_message dem on dem.email_message_id = (
	select msg.email_message_id
